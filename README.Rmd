...
```
Then, click on the `R-Work.Rproj` file. This will open RStudio and set the working directory to this folder `(...your computer path here.../R-Work/)`.
...
If you want to quickly view the plots, make sure that you have run the `Thesis.Rmd` file at least up to the "Begin statistical analysis" code. This will ensure that the data are processed and ready for plotting. Then, you can open and run the `Quick-Plot-Viewer.Rmd` file in the Figures subfolder.
