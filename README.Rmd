...
```{r download-screenshot, fig.align = 'center', fig.alt = "A screenshot of the GitHub download button showing an arrow pointing down at a rectangle. The text states 'Download raw file'", echo=F}
